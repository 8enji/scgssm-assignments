/**
 * Card.java
 * Author Ben Charest and the rest of the people in CS101
...
public class Card {
   ...
   /**
	 ...
	 *
	 * @param cardRank  a Stringvalue containing the rank of the card
	...
	public String toString() {
		String info = rank + " of " + suit + " (point value = " + pointValue + ")";
	   return info;
   }
}
